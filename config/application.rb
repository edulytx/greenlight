...
module Greenlight
  class Application < Rails::Application
    ...
    config.branding_image_default = "https://raifox.com/images/edulytx/logo.png"

    # Default primary color if the user does not specify one
    config.primary_color_default = "#226799"

    # Default primary color lighten if the user does not specify one
    config.primary_color_lighten_default = "#58C6C5"

    # Default primary color darken if the user does not specify one
    config.primary_color_darken_default = "#1B5178"
